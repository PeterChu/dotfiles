#--------------------------------------------------------
# Based on and modified from minimal theme at https://github.com/subnixr/minimal
#--------------------------------------------------------
...
[ -z "$MNML_PROMPT" ] && MNML_PROMPT=('mnml_cwd 2 0' mnml_ssh mnml_pyenv mnml_status)
...
function mnml_me_ls {
    # Disabled OS switch as we are using GNU Coreutils so 'ls' is the same as in Linux
